...
![Topcustomer Analysis](Results/Top_customer.png)

### Hightest Priced Product Analysis
![Hightest_priced product Analysis](Results/subquery.png)

### Revenue Filtering using HAVING Clause
![Revenue_filtering](Results/having_clause.png)
